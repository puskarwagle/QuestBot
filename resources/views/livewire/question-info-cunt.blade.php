        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-control">
                    ...
                    <input type="number" wire:model="years_of_experience" placeholder="e.g., 3" class="input input-bordered w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="form-control">
                    ...
                    <input type="number" wire:model="notice_period" placeholder="e.g., 2 weeks" class="input input-bordered w-full">
                    @error('notice_period')
                    <label class="label">
                        <span class="label-text-alt text-error">{{ $message }}</span>
                    </label>
